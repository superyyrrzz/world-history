...
root.innerHTML = `
  <header class="topbar">
    ...
    <a class="repo-link" href="https://github.com/superyyrrzz/world-history" target="_blank" rel="noopener noreferrer" aria-label="在 GitHub 上查看源码" title="在 GitHub 上查看源码">
